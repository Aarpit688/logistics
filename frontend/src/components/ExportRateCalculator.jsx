...
export default function ExportRateCalculator({
  onRatesCalculated,
  onResetAll,
}) {
    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <Field
          ...
          icon={<Map className="h-4 w-4 text-[#6b7280]" />}
          hintType={missingFields.destinationCountry ? "error" : "muted"}
        >
          <div className="relative w-full">
            <select
            ...
            >
              <option value="" disabled>
                {countriesLoading ? "Loading..." : "Select destination country"}
              </option>
